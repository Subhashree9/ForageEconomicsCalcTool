function marker2(minv, maxv, intf, valid, condv) {
  ...
  for (var i = minf; i < maxf; i = i + intf) {
    switch (condf) {
      ...
      case 'Ir':
        // alert("Entered Ir case");
        tIr = i;
        var fIr = parseFloat(i);
    ...
    function TFCval(af, bf, cf) {
      ...
      var INTv = (((((parseFloat(salval) + parseFloat(MPrice)) / 2) * (fIr / 100)) / optAH) * optTime).toFixed(1);
